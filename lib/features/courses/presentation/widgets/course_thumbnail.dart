...
class CourseThumbnail extends StatelessWidget {
  const CourseThumbnail({super.key, required this.path, this.size = 88, this.heroCourseId});
  ...
  Widget build(BuildContext context) {
    ...
    final placeholder = ColoredBox(
      ...
      child: Icon(Icons.school_outlined, color: colors.onSecondaryContainer, size: size * 0.4),
    );
    ...
    return courseId == null ? thumbnail : Hero(tag: 'course-thumbnail/$courseId', child: thumbnail);
  }
}
